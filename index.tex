...
\hypersetup{
  ...
  pdfauthor={Lisa DeBruine1, Iris Holzleitner1,2, Bernard Tiddeman3, \& Benedict C. Jones4},
  pdflang={en-EN},
...
\NormalTok{ingroup }\OtherTok{\textless{}{-}}\NormalTok{ f }\SpecialCharTok{|\textgreater{}}
  \CommentTok{\# pad 10\% at the top with matching color}
  \FunctionTok{pad}\NormalTok{(}\FloatTok{0.1}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{, }\AttributeTok{fill =} \FunctionTok{patch}\NormalTok{(f)) }\SpecialCharTok{|\textgreater{}} 
  \FunctionTok{label}\NormalTok{(}\StringTok{"Scottish"}\NormalTok{, }\StringTok{"north"}\NormalTok{, }\StringTok{"+0+10"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
...
\NormalTok{outgroup }\OtherTok{\textless{}{-}}\NormalTok{ f }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{pad}\NormalTok{(}\FloatTok{0.1}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{, }\AttributeTok{fill =} \FunctionTok{patch}\NormalTok{(f)) }\SpecialCharTok{|\textgreater{}} 
  \FunctionTok{label}\NormalTok{(}\StringTok{"Welsh"}\NormalTok{, }\StringTok{"north"}\NormalTok{, }\StringTok{"+0+10"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
...
\leavevmode\vadjust pre{\hypertarget{ref-bainbridge2013intrinsic}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-dado2022hyperrealistic}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-DeBruine2007JEPHPP}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-duchaine2015revised}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-gauthier2014conditional}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-goodfellow2014generative}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-hong2018boundary}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-jack2017toward}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-jenkins2011variability}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-jones2021world}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-jones_nomasc_2018}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kos2018adversarial}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-o2011adaptation}{}}%
O'Neil, S. F., \& Webster, M. A. (2011). Adaptation and the perception of facial age. \emph{Visual Cognition}, \emph{19}(4), 534--550.

\leavevmode\vadjust pre{\hypertarget{ref-olivola_social_2014}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-perrett1999symmetry}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-perrett1998effects}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-perrett1994facial}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-rhodes2011adaptive}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-saxena2021generative}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-schneider2012judging}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-shen2021study}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-shen2020interfacegan}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-stephen2012cross}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-todorov_understanding_2008}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-todorov2008understanding}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-tybur2022re}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-webster2011visual}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-zaltron2020cg}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-zebrowitz2008social}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-zhu2017unpaired}{}}%
